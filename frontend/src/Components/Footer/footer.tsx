                ...
                <footer className="footer col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    <div className="container">
                        <p style={{ marginLeft: '2.5rem', marginTop: '-0.08rem' }} className="copyright-paragraph">
                            ...
                            <a style={{ color:'black' }} href="https://docs.x.immutable.com/reference/#/" target="_blank" rel="noreferrer"><img src={require("../../assets/images/imx.png")} width="25" height="25" alt="logo" />IMX Scan</a><span style={{ marginLeft: '0.25rem', marginRight: '0.25rem' }}><b>|</b></span> 
